...
function getAllUrls(): string[] {
  ...
  return [
    BASE_URL,
    `${BASE_URL}/generate`,
    `${BASE_URL}/free-privacy-policy-generator`,
    `${BASE_URL}/free-terms-of-service-generator`,
    `${BASE_URL}/free-cookie-policy-generator`,
    `${BASE_URL}/free-refund-policy-generator`,
    `${BASE_URL}/free-disclaimer-generator`,
    `${BASE_URL}/blog`,

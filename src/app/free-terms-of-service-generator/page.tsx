...
import { Scale, FileText, Download, Globe, Check, Zap, ArrowRight, HelpCircle, Shield } from 'lucide-react';
...
export default function FreeTermsOfServiceGeneratorPage() {
  ...
  return (
    <>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          <h2 className="text-2xl font-bold text-center text-gray-900 mb-8">Other Legal Documents You Might Need</h2>
          <div className="grid sm:grid-cols-2 gap-4 max-w-2xl mx-auto">
            ...
            >
              ...
              <div>
                <span className="font-semibold text-gray-900">Cookie Policy Generator</span>
                <p className="text-xs text-gray-500">ePrivacy Directive compliant</p>
              </div>
            </Link>
          </div>
        </div>
